...
**foldchangeviz** is a Python package and command-line tool for visualizing fold change heatmaps from MALDI-TIMS-MS screening data. It provides a **GUI** for interactive use, or can be used as a command line tool. 
